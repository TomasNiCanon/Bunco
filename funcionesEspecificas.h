...
void estructuraAUX(); /// estructura de "AGITANDODADOS"
...
void AGITANDODADOS (){
char mensaje2[]="Agitando los dados";
...
int menuE() ///  THIS FUNCTION WELCOMES US, PRESENT THE MENU AND RETURN THE VALUE OF THE OPTION
{
    int opt;
    char WELCOME[] = "W E L C O M E   T O  T H E  B U N C O";
    estructuraPrimera();
    locate(24, 4);
    for(int i = 0; i < 38; i++)
    {
